<html>
    <head>
        ...
        <!-- Funções da página de inserção de modelos -->
        <script src="js/inserirModelos.js"></script>
        <!-- DataTables -->
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="inserirModelos.php"><i class="fa fa-plus"></i> Novo modelo</a></li>
