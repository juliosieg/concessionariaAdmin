<html>
    <head>
        ...
        <!-- Funções da página de listagem de categorias -->
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-motorcycle"></i>WHdev SGC</a></li>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <table id="tableCategorias" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th width='10%'>ID</th>
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" role="form">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="idEditarCategoria">ID:</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="idEditarCategoria">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="descricaoEditarCategoria">Descrição:</label>
                                    <div class="col-sm-10"> 
                                        <input type="text" class="form-control" id="descricaoEditarCategoria">
                                    </div>
                                </div>
                            </form>
